...
part of 'room_with_room_users_collection.dart';
...
const RoomCollectionSchema = CollectionSchema(
  ...
  indexes: {},
  links: {},
  embeddedSchemas: {r'UserCollection': UserCollectionSchema},
...
int _roomCollectionEstimateSize(
  ...
  bytesCount += 3 + object.roomUsers.length * 3;
  {
    final offsets = allOffsets[UserCollection]!;
    for (var i = 0; i < object.roomUsers.length; i++) {
      final value = object.roomUsers[i];
      bytesCount +=
          UserCollectionSchema.estimateSize(value, offsets, allOffsets);
    }
  }
...
void _roomCollectionSerialize(
  ...
  writer.writeObjectList<UserCollection>(
    offsets[5],
    allOffsets,
    UserCollectionSchema.serialize,
    object.roomUsers,
  );
...
RoomCollection _roomCollectionDeserialize(
  ...
  final object = RoomCollection(
    ...
    roomUsers: reader.readObjectList<UserCollection>(
          offsets[5],
          UserCollectionSchema.deserialize,
          allOffsets,
          UserCollection(),
        ) ??
        [],
...
P _roomCollectionDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 5:
      return (reader.readObjectList<UserCollection>(
            offset,
            UserCollectionSchema.deserialize,
            allOffsets,
            UserCollection(),
...
extension RoomCollectionQueryFilter
  ...
  QueryBuilder<RoomCollection, RoomCollection, QAfterFilterCondition>
      roomUsersLengthEqualTo(int length) {
    return QueryBuilder.apply(this, (query) {
...
extension RoomCollectionQueryObject
    on QueryBuilder<RoomCollection, RoomCollection, QFilterCondition> {
  QueryBuilder<RoomCollection, RoomCollection, QAfterFilterCondition>
      roomUsersElement(FilterQuery<UserCollection> q) {
    return QueryBuilder.apply(this, (query) {
      return query.object(q, r'roomUsers');
    });
  }
}
...
extension RoomCollectionQuerySortBy
  ...
  QueryBuilder<RoomCollection, RoomCollection, QAfterSortBy> sortByLogoUrl() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<RoomCollection, RoomCollection, QAfterSortBy> sortByName() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'name', Sort.asc);
    });
  }

  QueryBuilder<RoomCollection, RoomCollection, QAfterSortBy> sortByNameDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'name', Sort.desc);
    });
  }

  QueryBuilder<RoomCollection, RoomCollection, QAfterSortBy> sortByRoomId() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<RoomCollection, RoomCollection, QAfterSortBy> sortByType() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'type', Sort.asc);
    });
  }

  QueryBuilder<RoomCollection, RoomCollection, QAfterSortBy> sortByTypeDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension RoomCollectionQuerySortThenBy
  ...
  QueryBuilder<RoomCollection, RoomCollection, QAfterSortBy> thenByLogoUrl() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'logoUrl', Sort.asc);
    });
  }
  ...
  QueryBuilder<RoomCollection, RoomCollection, QAfterSortBy> thenByName() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'name', Sort.asc);
    });
  }

  QueryBuilder<RoomCollection, RoomCollection, QAfterSortBy> thenByNameDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'name', Sort.desc);
    });
  }

  QueryBuilder<RoomCollection, RoomCollection, QAfterSortBy> thenByRoomId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'roomId', Sort.asc);
    });
  }
  ...
  QueryBuilder<RoomCollection, RoomCollection, QAfterSortBy> thenByType() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'type', Sort.asc);
    });
  }

  QueryBuilder<RoomCollection, RoomCollection, QAfterSortBy> thenByTypeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'type', Sort.desc);
    });
  }
...
extension RoomCollectionQueryWhereDistinct
  ...
  QueryBuilder<RoomCollection, RoomCollection, QDistinct> distinctByDescription(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<RoomCollection, RoomCollection, QDistinct> distinctByLogoUrl(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<RoomCollection, RoomCollection, QDistinct> distinctByName(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<RoomCollection, RoomCollection, QDistinct> distinctByRoomId(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<RoomCollection, RoomCollection, QDistinct> distinctByType(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension RoomCollectionQueryProperty
  ...
  QueryBuilder<RoomCollection, DateTime, QQueryOperations> createdAtProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<RoomCollection, String?, QQueryOperations> logoUrlProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'logoUrl');
    });
  }

  QueryBuilder<RoomCollection, String?, QQueryOperations> nameProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'name');
    });
  }

  QueryBuilder<RoomCollection, String, QQueryOperations> roomIdProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'roomId');
    });
  }

  QueryBuilder<RoomCollection, List<UserCollection>, QQueryOperations>
      roomUsersProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'roomUsers');
    });
  }

  QueryBuilder<RoomCollection, String, QQueryOperations> typeProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'type');
    });
  }

  QueryBuilder<RoomCollection, DateTime, QQueryOperations> updatedAtProperty() {
    return QueryBuilder.apply(this, (query) {
