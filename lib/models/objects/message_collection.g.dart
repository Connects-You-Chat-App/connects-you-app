...
const MessageCollectionSchema = CollectionSchema(
  ...
  properties: {
    r'belongsToMessage': PropertySchema(
      id: 0,
      name: r'belongsToMessage',
      type: IsarType.object,
      target: r'EmbeddedMessage',
    ),
    ...
    r'forwardedFromRoomId': PropertySchema(
      id: 3,
      name: r'forwardedFromRoomId',
    ...
    r'senderUser': PropertySchema(
      ...
      name: r'senderUser',
      type: IsarType.object,
      target: r'MessageUserCollection',
    ),
  ...
  links: {},
  embeddedSchemas: {
    r'MessageUserCollection': MessageUserCollectionSchema,
    r'EmbeddedMessage': EmbeddedMessageSchema
  },
...
int _messageCollectionEstimateSize(
  ...
  {
    final value = object.belongsToMessage;
    if (value != null) {
      bytesCount += 3 +
          EmbeddedMessageSchema.estimateSize(
              value, allOffsets[EmbeddedMessage]!, allOffsets);
    }
  }
  {
    final value = object.forwardedFromRoomId;
    if (value != null) {
  ...
  bytesCount += 3 +
      MessageUserCollectionSchema.estimateSize(
          object.senderUser, allOffsets[MessageUserCollection]!, allOffsets);
...
void _messageCollectionSerialize(
  ...
  writer.writeObject<EmbeddedMessage>(
    offsets[0],
    allOffsets,
    EmbeddedMessageSchema.serialize,
    object.belongsToMessage,
  );
  writer.writeDateTime(offsets[1], object.createdAt);
  writer.writeDateTime(offsets[2], object.editedAt);
  writer.writeString(offsets[3], object.forwardedFromRoomId);
  ...
  writer.writeObject<MessageUserCollection>(
    offsets[8],
    allOffsets,
    MessageUserCollectionSchema.serialize,
    object.senderUser,
  );
...
MessageCollection _messageCollectionDeserialize(
  ...
  final object = MessageCollection(
    belongsToMessage: reader.readObjectOrNull<EmbeddedMessage>(
      offsets[0],
      EmbeddedMessageSchema.deserialize,
      allOffsets,
    ),
    createdAt: reader.readDateTimeOrNull(offsets[1]),
    editedAt: reader.readDateTimeOrNull(offsets[2]),
    forwardedFromRoomId: reader.readStringOrNull(offsets[3]),
    id: id,
    isDeleted: reader.readBool(offsets[4]),
    message: reader.readString(offsets[5]),
    messageId: reader.readString(offsets[6]),
    roomId: reader.readString(offsets[7]),
    senderUser: reader.readObjectOrNull<MessageUserCollection>(
          offsets[8],
          MessageUserCollectionSchema.deserialize,
          allOffsets,
        ) ??
        MessageUserCollection(),
    status: reader.readStringOrNull(offsets[9]) ?? MessageStatus.SENT,
...
P _messageCollectionDeserializeProp<P>(
  ...
  switch (propertyId) {
    case 0:
      return (reader.readObjectOrNull<EmbeddedMessage>(
        offset,
        EmbeddedMessageSchema.deserialize,
        allOffsets,
      )) as P;
    ...
    case 7:
      return (reader.readString(offset)) as P;
    case 8:
      return (reader.readObjectOrNull<MessageUserCollection>(
            offset,
            MessageUserCollectionSchema.deserialize,
            allOffsets,
          ) ??
          MessageUserCollection()) as P;
    case 9:
      return (reader.readStringOrNull(offset) ?? MessageStatus.SENT) as P;
    case 10:
      return (reader.readString(offset)) as P;
    case 11:
      return (reader.readDateTimeOrNull(offset)) as P;
...
extension MessageCollectionQueryFilter
  ...
  QueryBuilder<MessageCollection, MessageCollection, QAfterFilterCondition>
      belongsToMessageIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'belongsToMessage',
      ));
    });
  }

  QueryBuilder<MessageCollection, MessageCollection, QAfterFilterCondition>
      belongsToMessageIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<MessageCollection, MessageCollection, QAfterFilterCondition>
      forwardedFromRoomIdIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'forwardedFromRoomId',
      ));
    });
  }

  QueryBuilder<MessageCollection, MessageCollection, QAfterFilterCondition>
      forwardedFromRoomIdIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'forwardedFromRoomId',
      ));
  ...
  QueryBuilder<MessageCollection, MessageCollection, QAfterFilterCondition>
      forwardedFromRoomIdGreaterThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<MessageCollection, MessageCollection, QAfterFilterCondition>
      forwardedFromRoomIdContains(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<MessageCollection, MessageCollection, QAfterFilterCondition>
      forwardedFromRoomIdMatches(String pattern, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension MessageCollectionQueryObject
    on QueryBuilder<MessageCollection, MessageCollection, QFilterCondition> {
  QueryBuilder<MessageCollection, MessageCollection, QAfterFilterCondition>
      belongsToMessage(FilterQuery<EmbeddedMessage> q) {
    return QueryBuilder.apply(this, (query) {
      return query.object(q, r'belongsToMessage');
    });
  }

  QueryBuilder<MessageCollection, MessageCollection, QAfterFilterCondition>
      senderUser(FilterQuery<MessageUserCollection> q) {
    return QueryBuilder.apply(this, (query) {
...
extension MessageCollectionQuerySortBy
  ...
  QueryBuilder<MessageCollection, MessageCollection, QAfterSortBy>
      sortByForwardedFromRoomId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'forwardedFromRoomId', Sort.asc);
    });
  }

  QueryBuilder<MessageCollection, MessageCollection, QAfterSortBy>
      sortByForwardedFromRoomIdDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'forwardedFromRoomId', Sort.desc);
    });
  }
...
extension MessageCollectionQueryWhereDistinct
  ...
  QueryBuilder<MessageCollection, MessageCollection, QDistinct>
      distinctByForwardedFromRoomId({bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'forwardedFromRoomId',
          caseSensitive: caseSensitive);
    });
  }
...
extension MessageCollectionQueryProperty
  ...
  QueryBuilder<MessageCollection, EmbeddedMessage?, QQueryOperations>
      belongsToMessageProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'belongsToMessage');
    });
  }
  ...
  QueryBuilder<MessageCollection, String?, QQueryOperations>
      forwardedFromRoomIdProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'forwardedFromRoomId');
    });
  }

  QueryBuilder<MessageCollection, bool, QQueryOperations> isDeletedProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<MessageCollection, MessageUserCollection, QQueryOperations>
      senderUserProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<MessageCollection, String, QQueryOperations> typeProperty() {
    return QueryBuilder.apply(this, (query) {
...
const MessageUserCollectionSchema = Schema(
  name: r'MessageUserCollection',
  id: -7490258722841994956,
  properties: {
  ...
  estimateSize: _messageUserCollectionEstimateSize,
  serialize: _messageUserCollectionSerialize,
  deserialize: _messageUserCollectionDeserialize,
  deserializeProp: _messageUserCollectionDeserializeProp,
);

int _messageUserCollectionEstimateSize(
  MessageUserCollection object,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
  var bytesCount = offsets.last;
...
void _messageUserCollectionSerialize(
  MessageUserCollection object,
  IsarWriter writer,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
...
MessageUserCollection _messageUserCollectionDeserialize(
  Id id,
  IsarReader reader,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
  final object = MessageUserCollection(
...
P _messageUserCollectionDeserializeProp<P>(
  IsarReader reader,
  int propertyId,
  int offset,
  Map<Type, List<int>> allOffsets,
...
extension MessageUserCollectionQueryFilter on QueryBuilder<
    MessageUserCollection, MessageUserCollection, QFilterCondition> {
  QueryBuilder<MessageUserCollection, MessageUserCollection,
...
extension MessageUserCollectionQueryObject on QueryBuilder<
    MessageUserCollection, MessageUserCollection, QFilterCondition> {}

// coverage:ignore-file
// ignore_for_file: duplicate_ignore, non_constant_identifier_names, constant_identifier_names, invalid_use_of_protected_member, unnecessary_cast, prefer_const_constructors, lines_longer_than_80_chars, require_trailing_commas, inference_failure_on_function_invocation, unnecessary_parenthesis, unnecessary_raw_strings, unnecessary_null_checks, join_return_with_assignment, prefer_final_locals, avoid_js_rounded_ints, avoid_positional_boolean_parameters, always_specify_types

const EmbeddedMessageSchema = Schema(
  name: r'EmbeddedMessage',
  id: -6904910450735839424,
  properties: {
    r'isDeleted': PropertySchema(
      id: 0,
      name: r'isDeleted',
  ...
  estimateSize: _embeddedMessageEstimateSize,
  serialize: _embeddedMessageSerialize,
  deserialize: _embeddedMessageDeserialize,
  deserializeProp: _embeddedMessageDeserializeProp,
);

int _embeddedMessageEstimateSize(
  EmbeddedMessage object,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
  var bytesCount = offsets.last;
  ...
  }
  {
    ...
    if (value != null) {
      bytesCount += 3 +
          MessageUserCollectionSchema.estimateSize(
              value, allOffsets[MessageUserCollection]!, allOffsets);
    }
  }
  {
...
void _embeddedMessageSerialize(
  EmbeddedMessage object,
  IsarWriter writer,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
...
EmbeddedMessage _embeddedMessageDeserialize(
  Id id,
  IsarReader reader,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
  final object = EmbeddedMessage(
    isDeleted: reader.readBoolOrNull(offsets[0]),
    message: reader.readStringOrNull(offsets[1]),
    messageId: reader.readStringOrNull(offsets[2]),
...
P _embeddedMessageDeserializeProp<P>(
  IsarReader reader,
  int propertyId,
  int offset,
  Map<Type, List<int>> allOffsets,
...
extension EmbeddedMessageQueryFilter
    on QueryBuilder<EmbeddedMessage, EmbeddedMessage, QFilterCondition> {
  QueryBuilder<EmbeddedMessage, EmbeddedMessage, QAfterFilterCondition>
      isDeletedIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'isDeleted',
...
extension EmbeddedMessageQueryObject
    on QueryBuilder<EmbeddedMessage, EmbeddedMessage, QFilterCondition> {
  QueryBuilder<EmbeddedMessage, EmbeddedMessage, QAfterFilterCondition>
      senderUser(FilterQuery<MessageUserCollection> q) {
    return QueryBuilder.apply(this, (query) {
