...
class RoomControllerOld extends GetxController {
  ...
  Future _extractSharedKey() async {
    ...
    if (room.type == RoomType.DUET) {
      ...
      //     ),
      //   );
      //   await ServerApi.sharedKeyService.saveKey(
      //       SharedKey(key: sharedKey.encryptedKey, forUserId: otherUser.id));
      //
  ...
  Future sendMessage({
    ...
    _roomController.addMessageToRoom(messageObj);
